...
with st.sidebar:
    ...
    st.markdown(
        f'''<div class="sidebar-info-card">
            ...
            <b>Build</b><br>APP core build 80
        </div>''',
        unsafe_allow_html=True,
    )
...
if page == "Dashboard":
    ...
    if not dashboard_view.empty:
        ...
        df1, df2, df3 = st.columns([1, 1, 1.35])
    ...
    def _consultar_materiais(ops_pendencia, condicao, projeto, prioridade, data_campo, data_filtro, busca):
